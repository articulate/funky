...
exports.onSuccessP   = require('./lib/onSuccessP')
...
exports.renamePick   = require('./lib/renamePick')
exports.resolve      = require('./lib/resolve')
exports.tapP         = require('./lib/tapP')
exports.unlessP      = require('./lib/unlessP')
exports.useWithP     = require('./lib/useWithP')
exports.validate     = require('./lib/validate')
exports.validateWith = require('./lib/validateWith')
exports.whenP        = require('./lib/whenP')
